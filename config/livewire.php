...
return [
    ...
    */
    ...
    'temporary_file_upload' => [
        // Default `public` supaya sama dengan FileUpload receipt (livewire-tmp di storage/app/public).
        // Kalau env kosong, Livewire pakai FILESYSTEM_DISK=local → root private; di production sering bikin bingung.
        'disk' => env('LIVEWIRE_TEMPORARY_FILE_UPLOAD_DISK', 'public'),
        // max dalam kilobytes. Harus ≤ post_max_size & upload_max_filesize di php.ini, dan ≤ client_max_body_size di Nginx.
        'rules' => ['required', 'file', 'max:'.max(1024, (int) (env('LIVEWIRE_UPLOAD_MAX_KB') ?: 20480))],
